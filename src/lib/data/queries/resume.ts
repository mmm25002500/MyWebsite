...
export const getSkillGroups = cached(
  ['getSkillGroups'],
  async (locale: Locale): Promise<SkillGroup[]> => {
...
export const getHomeSkillGroups = cached(
  ['getHomeSkillGroups'],
  async (locale: Locale): Promise<SkillGroup[]> => {
...
export const getLanguages = cached(
  ['getLanguages'],
  async (locale: Locale): Promise<SpokenLanguage[]> => {
...
export const getInterests = cached(
  ['getInterests'],
  async (locale: Locale): Promise<Interest[]> => {
